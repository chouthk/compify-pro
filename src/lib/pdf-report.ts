...
const PDF_LABELS: Record<string, Record<string, string>> = {
  en: {
    ...
    footer: "Generated by Compify.Pro — AI-Powered Essay Grading",
  ...
  "zh-TW": {
    ...
    footer: "由 Compify.Pro 生成 — AI 作文批改系統",
    watermark: "免費版本",
  },
  "zh-CN": {
    reportTitle: "作文批改报告",
    ...
    footer: "由 Compify.Pro 生成 — AI 作文批改系统",
    watermark: "免费版本",
  },
};
...
function drawReportFrame(
  ...
  doc.setFont(fontFamily, "normal");
  doc.text("本報告內容僅供教學參考，最終成績以 HKEAA 官方評核為準。", pageWidth - margin, pageHeight - 11, { align: "right" });
...
function scoreToDse(score: number | null | undefined) {
...
function renderProfessionalReport(
  ...
  const finalLevel = scoreToDse(item.score);
  ...
  doc.text("DSE 換算參考等級", pillX + pillW / 2, y + 13, { align: "center" });
  doc.setFont(fontFamily, "bold");
  doc.setFontSize(14);
  doc.setTextColor(255, 255, 255);
